...
<body>
    ...
    <input type="text" name="cp_user" placeholder="cPanel Username" value="admin">
</div>
<div class="information-form-group col-sm-6 cpanel-credentials d-none">
    <input type="text" name="cp_password" placeholder="cPanel Password" value="123e45dfE#">
</div>
<div class="information-form-group col-sm-6">
    <input type="text" name="db_name" placeholder="Database Name" required value="trading_v2">
</div>
<div class="information-form-group col-sm-6">
    <input type="text" name="db_host" placeholder="Database Host" required value="host.docker.internal">
</div>
<div class="information-form-group col-sm-6">
    <input type="text" name="db_user" placeholder="Database User" required value="trading_user">
</div>
<div class="information-form-group col-sm-6">
    <input class="secure-password" type="text" name="db_pass" placeholder="Database Password" value="trading_password">
    <small class="d-none text-danger weak-password-error">Weak password detected</small>
</div>
									...
									<div class="info-item">
										...
										<div class="row">
											<div class="information-form-group col-lg-3 col-sm-6">
												...
												<input name="admin_user" type="text" value="admin" placeholder="Admin Username" required>
											</div>
											<div class="information-form-group col-lg-3 col-sm-6">
												<label>Password</label>
												<input name="admin_pass" type="text" value="123e45dfE@" placeholder="Admin Password" required>
											</div>
											<div class="information-form-group col-lg-6">
												<label>Email Address</label>
												<input name="email" value="admin@gmail.com" placeholder="Your Email address" type="email" required>
											</div>
										</div>
									</div>
									<div class="info-item">
