...
class UserController extends Controller
{
    public function home()
    {
        ...
        $recentOrders = $order->with('pair.coin')->orderBy('id', 'DESC')->take(5)->get();
        dd($recentOrders->count(), $recentOrders->pluck('id'));

        $recentTransactions = Transaction::where('user_id', $user->id)->orderBy('id', 'DESC')->take(5)->get();
